...
## 📈 Kiến trúc hệ thống & Quy trình (Architecture & Workflow)

### 1. Data Acquisition & ETL (Thu thập và xử lý dữ liệu)
...
### 2. Trực quan hóa dữ liệu (Data Analytics)
...
### 3. Mô hình gợi ý (Recommendation Engine)
...
### 4. Web Application (Ứng dụng Web)
...
* Python 3.9+
* Node.js (dành cho Frontend nếu chạy không qua Docker).

### Các bước triển khai
1. **Clone repository:**
   ```bash
   git clone [https://github.com/minhdon/E-commerce-Product-Scraping-Recommendation-System-.git]
   cd E-commerce-Product-Scraping-Recommendation-System-
2. **Thiết lập biến môi trường:**
   
Tạo file .env ở thư mục gốc và cấu hình các thông số kết nối MySQL (tham khảo env.example).
